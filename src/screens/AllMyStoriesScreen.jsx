...
const AllMyStoriesScreen = () => {
  const CATEGORIES = ['All', 'Readings', 'Completed'];

  const gotoOverallAnalytics = () => {
    navigation.navigate("overall-analytics")
  }

  const gotoStoryAnalytics = () => {
    navigation.navigate("story-analytics")
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headingContainer}>
        <Text style={styles.heading}>All my Stories</Text>
        <TouchableOpacity onPress={gotoOverallAnalytics}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.list}>
          <View style={styles.listItem}>
            ...
            <TouchableOpacity onPress={gotoStoryAnalytics}>
            <Icon
              name="line-chart"
              size={20}
              color="white"
          ...
          <View style={styles.listItem}>
            ...
            <View style={styles.bookDetails}>
              <Text style={styles.subText}>My First Love</Text>
              <Text style={styles.authorText}>Drafts - 5</Text>
              <Text style={styles.authorText}>Published - 10</Text>
              <View style={styles.statsContainer}>
                <View style={styles.statsSubContainer}>
          ...
          <View style={styles.listItem}>
            <TouchableOpacity>
              <Image
                source={require('../assets/roman.jpg')}
                style={styles.bookCover}
              />
            </TouchableOpacity>
            <View style={styles.bookDetails}>
              <Text style={styles.subText}>Roman</Text>
              <Text style={styles.authorText}>Drafts - 5</Text>
              <Text style={styles.authorText}>Published - 10</Text>
              <View style={styles.statsContainer}>
                <View style={styles.statsSubContainer}>
          ...
          <View style={styles.listItem}>
            ...
            <View style={styles.bookDetails}>
              <Text style={styles.subText}>A Pinky Promise</Text>
              <Text style={styles.authorText}>Drafts - 5</Text>
              <Text style={styles.authorText}>Published - 10</Text>
              <View style={styles.statsContainer}>
                <View style={styles.statsSubContainer}>
...
export default AllMyStoriesScreen;
